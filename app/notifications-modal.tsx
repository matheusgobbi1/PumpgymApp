        ...
        <ScrollView style={styles.content}>
          ...
          >
            ...
            <Switch
              ...
              thumbColor={
                workoutReminders ? colors.primary : colors.text + "30"
              }
              ios_backgroundColor={colors.border}
              onValueChange={(value) =>
                toggleSwitch(setWorkoutReminders, value)
              }
          ...
          >
            ...
            <Switch
              trackColor={{ false: colors.border, true: colors.primary + "70" }}
              thumbColor={
                goalAchievements ? colors.primary : colors.text + "30"
              }
              ios_backgroundColor={colors.border}
              onValueChange={(value) =>
                toggleSwitch(setGoalAchievements, value)
              }
          ...
          <Text style={[styles.disclaimer, { color: colors.text + "60" }]}>
            As notificações ajudam você a manter-se no caminho certo para
            atingir seus objetivos de fitness e nutrição.
          </Text>
        </ScrollView>
      </MotiView>
    </SafeAreaView>
