  ...
  return (
    ...
    >
      <View style={styles.setCardHeader}>
        <View style={[styles.setNumberContainer, { backgroundColor: color + '20' }]}>
          <Text style={[styles.setNumberText, { color }]}>Série {index + 1}</Text>
        </View>
      ...
      <View style={styles.setCardContent}>
        <View style={styles.setMetricContainer}>
          <View style={styles.setMetricHeader}>
            <Ionicons name="repeat-outline" size={16} color={color} style={styles.setMetricIcon} />
            <Text style={[styles.setMetricLabel, { color: colors.text }]}>Repetições</Text>
          </View>
          <View style={[styles.setMetricControls, { backgroundColor: colors.background + '80', borderRadius: 10 }]}>
            <TouchableOpacity
        ...
        <View style={styles.setMetricContainer}>
          <View style={styles.setMetricHeader}>
            <Ionicons name="barbell-outline" size={16} color={color} style={styles.setMetricIcon} />
            <Text style={[styles.setMetricLabel, { color: colors.text }]}>Carga (kg)</Text>
          </View>
          <View style={[styles.setMetricControls, { backgroundColor: colors.background + '80', borderRadius: 10 }]}>
            <TouchableOpacity
              style={[styles.setMetricButton, { backgroundColor: color + '15' }]}
            ...
            <TouchableOpacity
              style={[styles.setMetricButton, { backgroundColor: color + '15' }]}
              onPress={() => handleWeightChange(Math.min(200, set.weight + 2.5))}
            >
              <Ionicons name="add" size={18} color={color} />
            </TouchableOpacity>
          </View>
  ...
  return (
    ...
    >
      <View style={styles.cardioCardHeader}>
        <View style={[styles.cardioTitleContainer, { backgroundColor: color + '20' }]}>
          <Text style={[styles.cardioTitleText, { color }]}>Configuração do Cardio</Text>
        </View>
      </View>
      ...
      <View style={styles.cardioCardContent}>
        <View style={styles.cardioMetricContainer}>
          <View style={styles.cardioMetricHeader}>
            <Ionicons name="time-outline" size={16} color={color} style={styles.cardioMetricIcon} />
            <Text style={[styles.cardioMetricLabel, { color: colors.text }]}>Duração (minutos)</Text>
          </View>
          <Slider
          ...
          />
          <Text style={[styles.cardioMetricValue, { color: colors.text }]}>{duration} min</Text>
        </View>
        
        <View style={styles.cardioMetricContainer}>
          <View style={styles.cardioMetricHeader}>
            <Ionicons name="speedometer-outline" size={16} color={color} style={styles.cardioMetricIcon} />
            <Text style={[styles.cardioMetricLabel, { color: colors.text }]}>Intensidade</Text>
          </View>
          <Slider
            style={styles.cardioSlider}
            minimumValue={1}
          ...
          <View style={styles.intensityLabels}>
            <Text style={[styles.intensityLabel, { color: colors.text }]}>Baixa</Text>
            <Text style={[styles.intensityLabel, { color: colors.text }]}>Média</Text>
            <Text style={[styles.intensityLabel, { color: colors.text }]}>Alta</Text>
          </View>
        </View>
      </View>
    </MotiView>
...
export default function ExerciseDetailsScreen() {
  ...
  const [customExerciseName, setCustomExerciseName] = useState(customName || '');
          ...
          >
            {isLoading ? (
              ...
              <>
                ...
                >
                  <View style={[styles.exerciseIconContainer, { backgroundColor: workoutColor + '20' }]}>
                    <Ionicons
                      name={
                        exercise?.muscle === 'Peito' ? 'fitness-outline' :
                        exercise?.muscle === 'Costas' ? 'body-outline' :
                        exercise?.muscle === 'Pernas' ? 'walk-outline' :
                        exercise?.muscle === 'Ombros' ? 'barbell-outline' :
                        exercise?.muscle === 'Bíceps' || exercise?.muscle === 'Tríceps' ? 'bicycle-outline' :
                        exercise?.muscle === 'Abdômen' ? 'body-outline' :
                        exercise?.muscle === 'Cardio' ? 'heart-outline' : 'barbell-outline'
                      }
                      size={48}
                      color={workoutColor}
                    />
                  ...
                  {isCustomExercise ? (
                    <View style={styles.customNameContainer}>
                      <TextInput
                        style={[styles.customNameInput, { color: colors.text, borderColor: colors.border }]}
                  ...
                  {exercise && (
                    <View style={styles.exerciseDetails}>
                      <View style={[styles.exerciseDetailTag, { backgroundColor: workoutColor + '20' }]}>
                        <Text style={[styles.exerciseDetailTagText, { color: workoutColor }]}>
                          {exercise.muscle}
                        </Text>
                      </View>
                      ...
                      <View style={[styles.exerciseDetailTag, { 
                        backgroundColor: 
                          exercise.difficulty === 'iniciante' ? '#4CAF50' + '20' : 
                          exercise.difficulty === 'intermediário' ? '#FFC107' + '20' : 
                          '#F44336' + '20' 
                      }]}>
                        <Text style={[styles.exerciseDetailTagText, { 
                          color: 
                            exercise.difficulty === 'iniciante' ? '#4CAF50' : 
                            exercise.difficulty === 'intermediário' ? '#FFC107' : 
                            '#F44336' 
                        }]}>
                          {exercise.difficulty}
                        </Text>
                ...
                <MotiView
                  ...
                  style={[styles.configContainer, { backgroundColor: colors.card }]}
                >
                  ...
                  {exercise?.category === 'cardio' ? (
                    ...
                    <View style={styles.setsContainer}>
                      ...
                      <TouchableOpacity
                        ...
                        onPress={addNewSet}
                      >
                        <Ionicons name="add-circle-outline" size={20} color={workoutColor} />
                        <Text style={[styles.addSetButtonText, { color: workoutColor }]}>
                          Adicionar Série
                        </Text>
                      </TouchableOpacity>
                    </View>
