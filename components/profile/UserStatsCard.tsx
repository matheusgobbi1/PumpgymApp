...
export default function UserStatsCard({ onEditPress }: UserStatsCardProps) {
  ...
  const [activeTab, setActiveTab] = useState<'medidas' | 'objetivos'>('medidas');
  ...
  const calculateWeightProgress = () => {
    ...
    const initialWeight = nutritionInfo.goal === 'lose' 
    ...
    const progress = ((totalDifference - currentDifference) / totalDifference) * 100;
    ...
    >
      ...
      <View style={styles.tabsContainer}>
        <TouchableOpacity
          style={[
            styles.tab,
            activeTab === 'medidas' && [styles.activeTab, { borderBottomColor: colors.primary }]
          ]}
        ...
        >
          <Text 
            style={[
              styles.tabText, 
              { color: activeTab === 'medidas' ? colors.primary : colors.text + '70' }
            ]}
          >
            Medidas
          </Text>
        ...
        <TouchableOpacity
          style={[
            styles.tab,
            activeTab === 'objetivos' && [styles.activeTab, { borderBottomColor: colors.primary }]
          ]}
        ...
        >
          <Text 
            style={[
              styles.tabText, 
              { color: activeTab === 'objetivos' ? colors.primary : colors.text + '70' }
            ]}
          >
            Objetivos
          </Text>
        ...
        <Animated.View entering={FadeIn.duration(300)} style={styles.tabContent}>
          <View style={styles.mainStatsContainer}>
            ...
            <View style={styles.mainStatItem}>
              <View style={[styles.mainStatIconContainer, { backgroundColor: colors.primary + '15' }]}>
              ...
              <Text style={[styles.mainStatLabel, { color: colors.text + '80' }]}>cm</Text>
            </View>
            ...
            <View style={styles.mainStatItem}>
              ...
              <Text style={[styles.mainStatLabel, { color: colors.text + '80' }]}>kg</Text>
            </View>
            ...
            <View style={styles.mainStatItem}>
              ...
              <Text style={[styles.mainStatLabel, { color: colors.text + '80' }]}>anos</Text>
            </View>
          </View>
          ...
          <View style={styles.additionalInfoContainer}>
            <View style={styles.infoRow}>
              <View style={styles.infoItem}>
                <Text style={[styles.infoLabel, { color: colors.text + '70' }]}>Gênero</Text>
              ...
              <View style={styles.infoItem}>
                <Text style={[styles.infoLabel, { color: colors.text + '70' }]}>Frequência de Treino</Text>
                <Text style={[styles.infoValue, { color: colors.text }]}>
                  {nutritionInfo.trainingFrequency 
                    ? nutritionInfo.trainingFrequency.charAt(0).toUpperCase() + nutritionInfo.trainingFrequency.slice(1) 
                    : "Não informado"}
                </Text>
              </View>
            </View>
        ...
        <Animated.View entering={FadeIn.duration(300)} style={styles.tabContent}>
          ...
          <View style={styles.goalContainer}>
            <View style={styles.goalHeader}>
              ...
              <View>
                <Text style={[styles.goalLabel, { color: colors.text + '80' }]}>Objetivo Principal</Text>
            ...
            {nutritionInfo.targetWeight && nutritionInfo.weight && (
              <View style={styles.weightProgressContainer}>
                <View style={styles.weightProgressHeader}>
                  <Text style={[styles.weightCurrentValue, { color: colors.text }]}>
                    {nutritionInfo.weight} kg
                  </Text>
                  <Text style={[styles.weightTargetValue, { color: colors.primary }]}>
                ...
                <Text style={[styles.progressText, { color: colors.text + '70' }]}>
                  {weightProgress ? `${Math.round(weightProgress)}% concluído` : 'Progresso não disponível'}
                </Text>
              </View>
            )}
          </View>
          ...
          {nutritionInfo.targetDate && (
            <View style={styles.targetDateContainer}>
              <View style={[styles.targetDateIconContainer, { backgroundColor: colors.primary + '15' }]}>
                <Ionicons name="calendar" size={20} color={colors.primary} />
              </View>
              <View>
                <Text style={[styles.targetDateLabel, { color: colors.text + '80' }]}>Data Alvo</Text>
                <Text style={[styles.targetDateValue, { color: colors.text }]}>
                  {format(new Date(nutritionInfo.targetDate), "dd 'de' MMMM 'de' yyyy", { locale: ptBR })}
                </Text>
              </View>
            </View>
          )}
          ...
          {nutritionInfo.calories && (
            <View style={styles.macrosContainer}>
              <Text style={[styles.macrosTitle, { color: colors.text }]}>Plano Nutricional</Text>
              
              <View style={styles.macrosRow}>
                <View style={styles.macroItem}>
                  <View style={[styles.macroIconContainer, { backgroundColor: '#FF6B6B20' }]}>
                    <MaterialCommunityIcons name="fire" size={18} color="#FF6B6B" />
                  </View>
                  <Text style={[styles.macroValue, { color: colors.text }]}>{nutritionInfo.calories}</Text>
                  <Text style={[styles.macroLabel, { color: colors.text + '70' }]}>kcal</Text>
                </View>
                
                <View style={styles.macroItem}>
                  <View style={[styles.macroIconContainer, { backgroundColor: '#4ECDC420' }]}>
                    <MaterialCommunityIcons name="food-steak" size={18} color="#4ECDC4" />
                  </View>
                  <Text style={[styles.macroValue, { color: colors.text }]}>{nutritionInfo.protein || '--'}</Text>
                  <Text style={[styles.macroLabel, { color: colors.text + '70' }]}>proteína</Text>
                </View>
                
                <View style={styles.macroItem}>
                  <View style={[styles.macroIconContainer, { backgroundColor: '#FFD16620' }]}>
                    <MaterialCommunityIcons name="bread-slice" size={18} color="#FFD166" />
                  </View>
                  <Text style={[styles.macroValue, { color: colors.text }]}>{nutritionInfo.carbs || '--'}</Text>
                  <Text style={[styles.macroLabel, { color: colors.text + '70' }]}>carboidratos</Text>
                </View>
                
                <View style={styles.macroItem}>
                  <View style={[styles.macroIconContainer, { backgroundColor: '#118AB220' }]}>
                    <MaterialCommunityIcons name="oil" size={18} color="#118AB2" />
                  </View>
                  <Text style={[styles.macroValue, { color: colors.text }]}>{nutritionInfo.fat || '--'}</Text>
                  <Text style={[styles.macroLabel, { color: colors.text + '70' }]}>gorduras</Text>
                </View>
              </View>
            </View>
          )}
